function submit(){
    ...
    validInput(fname,fnameError);
    validInput(lname,lnameError);
    validInput(country,countryError);
    validInput(street,streetError);
    validInput(snumber,snumberError);
    validInput(message,messageError);
    }
